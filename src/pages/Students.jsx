...
import { addStudentThunk } from "../store/slices/students.slice";
  ...
  return (
    ...
    >
      ...
      <Typography color="gray" className="mt-1 font-normal">
        En este apartado podrás crear nuevos estudiantes, se cuidadoso con la
        información.
      </Typography>
      <form
        // className="forms"
      ...
      >
        ...
        <br />
        {/* {checkbox === false && <span style={{color: "red", fontSize: 12,  fontStyle: "italic", margin: -14, marginBottom: -6}}>Debes aceptar los términos y condiciones antes de añadir un nuevo estudiante.</span> } */}
        <Button type="submit" className="m-5" onClick={addStudent}>
          Añadir
        </Button>
        {successAlert === true && (
